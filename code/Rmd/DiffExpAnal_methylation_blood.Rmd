...
knit2synapse::knitToFolderEntity(file = "./DiffExpAnal_methylation_blood.Rmd", 
                                 parentId = 'syn4231339',
                                 entityName = 'Differential Expression Analysis Methylation Blood', 
                                 overwrite=F)
...
tmp <- mutate(tmp, changeInBeta=var1Mean - var2Mean,
              Comparison=ifelse(logFC > 0, "blood__up", "blood__down"))

write.table(tmp, file='./DiffExpAnal_methylation_blood_topTable.tsv')
```
...
activityName='Differential Expression Analysis of minfi processed methylation data - blood vs non-blood samples'
